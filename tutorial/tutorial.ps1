...
while ($true) {
    ...
    # Snapshot pre-chapter buckets so tut-wipe only removes what lessons create
    $script:preChapterBuckets = Get-ChildItem (Get-BucketRoot) -Directory -ErrorAction SilentlyContinue | ForEach-Object Name
